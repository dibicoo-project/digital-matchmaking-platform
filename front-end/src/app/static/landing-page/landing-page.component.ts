...
export class LandingPageComponent implements OnInit {
  ...
  allFeedbacks: Feedback[] = [
    ...
    {
      loaded: false,
      avatarUrl: 'https://storage.googleapis.com/dibicoo-matchmaking-tool.appspot.com/testimonials/Vitalijs.png',
      name: 'Vitalijs Komasilovs',
      title: 'Latvia University of Life Sciences and Technologies',
      text: 'Development process of the matchmaking platform was very exciting and challenging. We have used an iterative approach \
        to continuously improve the platform and implement as much features as possible.',
    },
  ...
  latest: { id: string; companyName: string; imageUrl: string }[];
  ...
  ngOnInit(): void {
    ...
    this.api.get('/api/enterprises/latest').subscribe((list: any) => this.latest = list);
  }
}
